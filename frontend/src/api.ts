...
export type CanvasObjectData = { text?: string; font_size?: number; font_family?: string; font_weight?: boolean; font_style?: boolean; text_align?: 'left' | 'center' | 'right' | 'justify'; color?: string; rotation?: number; flip_x?: boolean; flip_y?: boolean }
